...
@TestPropertySource(
    properties = [
        ...
        "yaytsa.scrobbling.listenbrainz.username=nobody-configured-this-username",
...
class ListenBrainzScrobbleUnresolvedUsernameIntegrationTest {
    ...
    companion object {
        ...
        private val postgres: PostgreSQLContainer<*> =
            PostgreSQLContainer("pgvector/pgvector:pg16")
                .withDatabaseName("scrobble_unresolved_username_test")
                .withUsername("test")
                .withPassword("test")
    ...
    @Test
    fun `configured username matching no known user safely no-ops instead of throwing`() {
        val playId =
            playHistoryJpa
                .save(
                    PlayHistoryEntity(
