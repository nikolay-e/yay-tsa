...
public class SystemController {
    ...
    public ResponseEntity<SystemInfoResponse> getPublicSystemInfo() {
        SystemInfoResponse info = SystemInfoResponse.publicInfo(serverName, version, serverId, getLocalAddress());
    ...
    public ResponseEntity<SystemInfoResponse> getSystemInfo(
        ...
        SystemInfoResponse info = SystemInfoResponse.fullInfo(serverName, version, serverId, getLocalAddress(), null);
        return ResponseEntity.ok(info);
    }
