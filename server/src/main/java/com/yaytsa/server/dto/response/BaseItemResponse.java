...
/**
 * Base item response matching Jellyfin API specification.
...
public record BaseItemResponse(
    ...
    public static class Builder {
        ...
        public Builder isFolder(Boolean isFolder) { this.isFolder = isFolder; return this; }
        ...
        public Builder userData(UserItemDataDto userData) { this.userData = userData; return this; }
        public Builder albumId(String albumId) { this.albumId = albumId; return this; }
        public Builder albumPrimaryImageTag(String tag) { this.albumPrimaryImageTag = tag; return this; }
        public Builder albumArtist(String albumArtist) { this.albumArtist = albumArtist; return this; }
        public Builder albumArtists(List<NameGuidPair> albumArtists) { this.albumArtists = albumArtists; return this; }
        public Builder artists(List<String> artists) { this.artists = artists; return this; }
        public Builder artistItems(List<NameGuidPair> artistItems) { this.artistItems = artistItems; return this; }
        ...
        public Builder genreItems(List<NameGuidPair> genreItems) { this.genreItems = genreItems; return this; }
        public Builder imageTags(Map<String, String> imageTags) { this.imageTags = imageTags; return this; }
        public Builder indexNumber(Integer indexNumber) { this.indexNumber = indexNumber; return this; }
        public Builder parentIndexNumber(Integer parentIndexNumber) { this.parentIndexNumber = parentIndexNumber; return this; }
        public Builder runTimeTicks(Long runTimeTicks) { this.runTimeTicks = runTimeTicks; return this; }
        public Builder dateCreated(OffsetDateTime dateCreated) { this.dateCreated = dateCreated; return this; }
        ...
        public BaseItemResponse build() {
            return new BaseItemResponse(
                name, originalTitle, serverId, id, etag, sourceType, playlistItemId,
                dateCreated, dateLastMediaAdded, extraType, sortName, forcedSortName,
                premiereDate, overview, officialRating, customRating, communityRating,
                criticRating, indexNumber, parentIndexNumber, indexNumberEnd, runTimeTicks,
                type, isFolder, mediaType, collectionType, parentId, parentLogoItemId,
                parentBackdropItemId, parentBackdropImageTags, userData, albumId,
     ...
     */
    public static BaseItemResponse audioTrack(String id, String name, String sortName,
     ...
     */
    public static BaseItemResponse album(String id, String name, String sortName,
