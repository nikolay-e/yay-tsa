...
import com.example.mediaserver.domain.service.ImageService;
...
public class ImagesController {
    ...
    public ResponseEntity<byte[]> getItemImage(
            ...
            @Parameter(description = "Image quality (1-100)") @RequestParam(required = false) Integer quality,
            @Parameter(description = "Output format (webp, jpeg, png)") @RequestParam(defaultValue = "webp") String format,
    ...
    public ResponseEntity<byte[]> getItemImageByIndex(
        ...
        return getItemImage(itemId, imageType, apiKey, tag, maxWidth, maxHeight, quality, format, webRequest);
    }
