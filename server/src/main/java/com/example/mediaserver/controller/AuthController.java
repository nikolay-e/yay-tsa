...
import com.example.mediaserver.dto.request.AuthenticateByNameRequest;
...
public class AuthController {
    ...
    public ResponseEntity<AuthenticationResultDto> authenticateByName(
        ...
        try {
            ...
            UserDto userDto = userMapper.toDto(result.user());
            ...
            AuthenticationResultDto response = AuthenticationResultDto.create(
                userDto,
                sessionInfo,
                result.accessToken()
            );
