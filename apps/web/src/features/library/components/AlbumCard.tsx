      ...
      <button
        ...
        className={cn(
          ...
          isPlaying
            ...
            : 'scale-90 opacity-0 group-focus-within:scale-100 group-focus-within:opacity-100 group-hover:scale-100 group-hover:opacity-100 max-md:scale-100 max-md:opacity-100',
