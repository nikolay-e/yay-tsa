<script lang="ts">
  ...
  import { hapticPlayPause, hapticSelect } from '../../../lib/shared/utils/haptics.js';
  import { LIBRARY_TEST_IDS } from '../../../lib/shared/test-ids/index.js';
  ...
  // Reactive data loading - re-runs when albumId changes
  $: if (albumId) {
    void loadAlbumData();
  }
