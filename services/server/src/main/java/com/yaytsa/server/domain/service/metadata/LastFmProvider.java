...
public class LastFmProvider implements MetadataProvider {
  ...
  @Value("${yaytsa.metadata.lastfm.api-key:}")
  private String apiKey;

  public LastFmProvider(RestTemplateBuilder restTemplateBuilder) {
    this.restTemplate =
  ...
  private double calculateConfidence(
      String originalArtist, String originalTitle, LastFmTrack track) {
  ...
  @JsonIgnoreProperties(ignoreUnknown = true)
  record LastFmAlbum(String title, LastFmArtist artist, LastFmWiki wiki) {}
