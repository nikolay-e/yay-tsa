...
public record SessionInfoResponse(
    ...
    @JsonProperty("NowPlayingItem") BaseItemResponse nowPlayingItem,
    @JsonProperty("NowViewingItem") BaseItemResponse nowViewingItem,
    ...
    @JsonProperty("NowPlayingQueueFullItems") List<BaseItemResponse> nowPlayingQueueFullItems,
