...
public class SpotifyProvider implements MetadataProvider {
  ...
  @Value("${yaytsa.metadata.spotify.client-id:}")
  private String clientId;

  @Value("${yaytsa.metadata.spotify.client-secret:}")
  ...
  public SpotifyProvider(RestTemplateBuilder restTemplateBuilder) {
    this.restTemplate =
  ...
  private double calculateConfidence(
      String originalArtist, String originalTitle, SpotifyTrack track) {
  ...
  @JsonIgnoreProperties(ignoreUnknown = true)
  record SpotifyTrack(
      String name, List<SpotifyArtist> artists, SpotifyAlbum album, Integer popularity) {}
  ...
  @JsonIgnoreProperties(ignoreUnknown = true)
  record SpotifyAlbum(
      String name, @JsonProperty("release_date") String releaseDate, List<String> genres) {}
}
