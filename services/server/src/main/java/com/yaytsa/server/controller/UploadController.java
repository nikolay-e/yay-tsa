...
public class UploadController {
  ...
  @Operation(
      ...
      description =
          "Upload a music file to the library. Metadata is automatically extracted from the file"
              + " tags. Supports: mp3, flac, m4a, aac, ogg, opus, wav, wma. Max size: 100MB.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "201",
  ...
  public ResponseEntity<?> uploadTrack(
    ...
    if (originalFilename == null || !hasValidExtension(originalFilename)) {
      return ResponseEntity.badRequest()
          .body("Unsupported file format. Supported: " + String.join(", ", SUPPORTED_EXTENSIONS));
    }
