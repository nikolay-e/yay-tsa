      ...
      .then(async () => {
        ...
        if (!this.sourceNode && this.audioContext) {
          try {
            ...
            // Try to create analyser for RMS measurement
            try {
              ...
              // Fallback: connect directly to destination without analyser
              // This ensures audio still works even if analyser creation fails
              this.analyser = null;
