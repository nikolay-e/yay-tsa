<script lang="ts">
  ...
  const presetOptions = [
    { id: '15min', label: '15 min', description: 'Music only' },
    { id: '30min', label: '30 min', description: 'Music only' },
    { id: '1h', label: '1 hour', description: 'Music only' },
    { id: '1h+1h', label: '1h + 1h', description: 'Music then pink noise' },
    { id: '2h+1h', label: '2h + 1h', description: 'Music then pink noise' },
  ];
